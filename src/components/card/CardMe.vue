<template>
  <el-card>
    ...
    <div class="me-author-description">
      ...
      <span><i class="me-icon-job"></i> &nbsp;开发者SL</span>
    </div>
...
<script>
  export default {
    ...
    data() {
      return {
        qq: {title: 'QQ', message: '861340241'},
        bilibili: {
          title: '哔哩哔哩',
          message: '<a target="_blank" href="https://space.bilibili.com/1182744026">https://space.bilibili.com/1182744026</a>'
        }
      }
    },
    methods: {
